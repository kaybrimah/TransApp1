...
public class TrackShuttle extends FragmentActivity implements OnMapReadyCallback, View.OnClickListener {
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
                    ...
                    double d1lat = latitude+0.0020;
                    double d1lng = longitude+0.0020;
                    double d2lat = latitude+0.006;
                    double d2lng =longitude+0.006;
                    double d3lat = latitude-0.009;
                    double d3lng = longitude-0.009;


        LatLng latLng1 = new LatLng(d1lat, d1lng);
        LatLng latLng2 = new LatLng( d2lat , d2lng);
        LatLng latLng3 = new LatLng(d3lat ,  d3lng);
        ...
        if (mMap != null) {
            ...
            mMap.addMarker(new MarkerOptions().position(latLng3).icon(BitmapDescriptorFactory.fromResource(R.drawable.mapicon9)));
            mMap.addMarker(new MarkerOptions().position(latLng1).icon(BitmapDescriptorFactory.fromResource(R.drawable.mapicon9)));
            mMap.addMarker(new MarkerOptions().position(latLng2).icon(BitmapDescriptorFactory.fromResource(R.drawable.mapicon9)));
...
//                    double d1lat = u_latitude+0.0002;
//                    double d1lng = u_latitude+0.0002;
//                    double d2lat = u_latitude+0.0007;
//                    double d2lng = u_latitude+0.0007;
//                    double d3lat = u_latitude+0.0008;
//                    double d3lng = u_latitude+0.0009;
//                    double d4lat = u_latitude+0.0004;
//                    double d4lng= u_latitude+0.0005;
